...
insert into health_care_provider values (011564,'John Williams','Vancouver'); --
insert into health_care_provider values (254099,'Patricia Jones','Montreal'); --
insert into health_care_provider values (090873,'Elizabeth Taylor','Montreal');
...
insert into health_care_provider values (619023,'Jennifer Thomas','Ottowa'); --
...
insert into health_care_provider values (334051,'Lucas Zamprogno','Ottowa');
...
insert into family_physician values (011564,'John Williams','Vancouver'); --
...
insert into family_physician values (619023,'Jennifer Thomas','Ottowa'); --
...
insert into specialist values (090873,'Elizabeth Taylor','Montreal');
...
insert into specialist values (334051,'Lucas Zamprogno','Ottowa');
insert into specialist values (472122,'Vanessa Aeschbach','Regina');
insert into specialist values (163784,'Varoon Mathur','Winnipeg');

insert into patient_registered values(060839453,'Charles Harris','Vancouver');
insert into patient_registered values(099354543,'Susan Martin','Montreal');
...
insert into patient_registered values(451519864,'Mark Young','Ottowa');
...
insert into patient_registered values(578875478,'Edward Baker','Ottowa');

-- HEALTH CARE RECORD
-- HAS APPOINTMENT
-- IS ON
insert into waitlist values('Vancouer', 'Cardiology');
insert into waitlist values('Vancouer', 'Oncology');
insert into waitlist values('Vancouer', 'Podiatry');
insert into waitlist values('Vancouer', 'Radiology');
insert into waitlist values('Vancouer', 'Surgery');
