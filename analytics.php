	...
	<body>
		...
		if ($db_conn){
			...
			if(array_key_exists('view', $_POST)) {
				...
				$allPatients = executePlainSQL("select p.name, p.carecardnum from patient_registered p where not exists ((select distinct medName from medication) minus (select distinct m.medName from medication m, takes t where t.carecardnum = p.carecardnum and m.medName = t.medName))");

				$allPatients2 = executePlainSQL("select p.name, p.carecardnum from patient_registered p where not exists ((select distinct medName from medication) minus (select distinct m.medName from medication m, takes t where t.carecardnum = p.carecardnum and m.medName = t.medName))");
		...
		function displayTitle($sequence) {
			if($sequence == "AGCT") {
				echo "<b><small><font face=\"Arial\"> Geographic Distribution of Patients at risk of: Type 2 Diabetes </font></small></b><br></br>";
			} else if ($sequence == "TAGA") {
				echo "<b><small><font face=\"Arial\"> Geographic Distribution of Patients at risk of: Cardiovascular Disease </font></small></b><br></br>";
			} else if ($sequence == "GCGC") {
				echo "<b><small><font face=\"Arial\"> Geographic Distribution of Patients at risk of: Neurodegenerative Disease </font></small></b><br></br>";
			} else if ($sequence == "CGCG") {
				echo "<b><small><font face=\"Arial\"> Geographic Distribution of Patients at risk of: Viral Epidemics </font></small></b><br></br>";
			} else if ($sequence == "AAAA") {
				echo "<b><small><font face=\"Arial\"> Geographic Distribution of Patients at risk of: Repiratory Infections </font></small></b><br></br>";
			} else if ($sequence == "TATA") {
				echo "<b><small><font face=\"Arial\"> Geographic Distribution of Patients at risk of: Bacterial Infections </font></small></b><br></br>";
			} else if ($sequence == $_POST['other']) {
				echo "<b><small><font face=\"Arial\"> Custom Sequence: $sequence </font></small></b><br></br>";
			}
		}
		...
		function validateResult3($result, $resultNext) { //Checks if the Query is Empty, then sends a copy of the result to print
			if(!$row = OCI_Fetch_Array($result, OCI_BOTH)) {
				echo "<b><small><font face=\"Arial\"> None. </font></small></b>";
			}
			else{
		...
		function printResult3($result){
			...
			while ($row = OCI_Fetch_Array($result, OCI_BOTH)){
				echo "<tr><td>" . $row["P.NAME"] . "</td><td>" . $row["P.CARECARDNUM"] . "</td></tr>"; 
			}
			echo "</table>";  
		}
		...
		function validateResult4($result, $resultNext) { //Checks if the Query is Empty, then sends a copy of the result to print
			if(!$row = OCI_Fetch_Array($result, OCI_BOTH)) {
				echo "<b><small><font face=\"Arial\"> No Dose on Record. </font></small></b>";
			}
			else{
		...
		function printResult4($result){
			echo "<table>";
			echo "<tr><th><small><font face=\"Arial\">Medication</font></small></b></th><th><b><small><font face=\"Arial\"> Dose </font></small></b></th></tr>";
			while ($row = OCI_Fetch_Array($result, OCI_BOTH)){
				echo "<tr><td><small><font face=\"Arial\">" . $row["MEDNAME"] . "</font></small></td><td><small><font face=\"Arial\">" . $row["MIN(DOSE)"] . "</font></small></td></tr>"; 
			}
			echo "</table>";  
		}
		...
		function printResult5($result){
			...
			echo "<tr><th><small><font face=\"Arial\">Medication</font></small></b></th><th><b><small><font face=\"Arial\"> Dose </font></small></b></th></tr>";
			while ($row = OCI_Fetch_Array($result, OCI_BOTH)){
				echo "<tr><td><small><font face=\"Arial\">" . $row["MEDNAME"] . "</font></small></td><td><small><font face=\"Arial\">" . $row["MAX(DOSE)"] . "</font></small></td></tr>"; 
			}
			echo "</table>";  
		}
		...
		function printResult6($result){
			echo "<table>";
			echo "<tr><th><small><font face=\"Arial\">Ethnicity</font></small></b></th><th><b><small><font face=\"Arial\">Number of Patients</font></small></b></th><th><b><small><font face=\"Arial\">Average Age</font></small></b></th>";
			while ($row = OCI_Fetch_Array($result, OCI_BOTH)){
				echo "<tr><td><small><font face=\"Arial\">" . $row["ETHNICITY"] . "</font></small></td><td><small><font face=\"Arial\">" . $row["COUNT(*)"] . "</font></small></td><td><small><font face=\"Arial\">" . $row["AVG(AGE)"] . "</font></small></td></tr>"; 
			}
			echo "</table>";  
		}
		...
		<?php
		echo "<br></br><b><small><font face=\"Arial\"> Number of Patients by Ethnicity and Average Age in Health System: </font></small></b>";
		echo "<p></p>";
		validateResult6($patientsEthnicity, $patientsEthnicity2);

		echo "<br></br><b><small><font face=\"Arial\"> Patient Prescription Analytics: </font></small></b>";
		echo "<p></p>";
		echo "<small><font face=\"Arial\"> Patients prescribed all available medications: </font></small>";
		validateResult3($allPatients, $allPatients2);
		echo "<br></br>";
		echo "<small><font face=\"Arial\"> Lowest prescribed Dose of all prescriptions: </font></small>";
		validateResult4($lowestDose, $lowestDose2);
		echo "<br></br>";
		echo "<small><font face=\"Arial\"> Highest prescribed Dose of all prescriptions: </font></small>";
